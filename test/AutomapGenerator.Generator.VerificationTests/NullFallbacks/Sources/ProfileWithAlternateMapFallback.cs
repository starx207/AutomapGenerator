...
public class ProfileWithAlternateMapFallback : MapProfile, ISourceFile {
    public ProfileWithAlternateMapFallback() 
        ...
        .ForMember(d => d.MappedString, o => o.MapFrom(s => s.NullableString ?? s.NonNullString))
        .ForMember(d => d.NullableMappedString, o => o.MapFrom(s => s.NullableString ?? s.OtherNullableString));
