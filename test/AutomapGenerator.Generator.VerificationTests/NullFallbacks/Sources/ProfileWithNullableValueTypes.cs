...
public class ProfileWithNullableValueTypes : MapProfile, ISourceFile {
    public ProfileWithNullableValueTypes()
        ...
        .ForMember(d => d.NonNullableRefMapWithPropertyFallback, o => o.MapFrom(s => s.NullableRefType, s => s.NonNullableRefType))
        ...
        .ForMember(d => d.NullableRefMapWithPropertyFallback, o => o.MapFrom(s => s.NullableRefType, s => s.NonNullableRefType))
        .ForMember(d => d.NullableRefIgnored, o => o.Ignore())

        .ForMember(d => d.NullableRefType, o => o.NullFallback("test"))
        .ForMember(d => d.SourceWithNullableValueTypesNullableRefType, o => o.NullFallback(s => s.NonNullableRefType))
        ...
        .ForMember(d => d.NonNullableValueMapWithPropertyFallback, o => o.MapFrom(s => s.NullableValueType, s => s.NonNullableValueType))
        ...
        .ForMember(d => d.NullableValueMapWithPropertyFallback, o => o.MapFrom(s => s.NullableValueType, s => s.NonNullableValueType))
        .ForMember(d => d.NullableValueIgnored, o => o.Ignore())

        .ForMember(d => d.NullableValueType, o => o.NullFallback(99))
        .ForMember(d => d.SourceWithNullableValueTypesNullableValueType, o => o.NullFallback(s => s.NonNullableValueType))
        ;
