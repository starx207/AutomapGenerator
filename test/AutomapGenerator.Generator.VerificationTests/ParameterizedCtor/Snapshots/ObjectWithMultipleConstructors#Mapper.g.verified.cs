...
{
    // TODO: I need to modify this with what I actually expect
    ...
    public class Mapper : IMapper
    {
        public TDestination Map<TDestination>(object source)
        {
            ...
            {
                case (AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj s, System.Type t) when t == typeof(AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithMultipleCtor):
                    return (dynamic)MapInternal(s, new AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithMultipleCtor());
                default:
        ...
        public TDestination Map<TDestination>(object source, TDestination destination)
        {
            ...
            {
                case (AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj s, AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithMultipleCtor d):
        ...
        private AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithMultipleCtor MapInternal(AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj source, AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithMultipleCtor destination)
        {
        ...
        private global::System.Linq.IQueryable<TDestination> ProjectInternal<TDestination>(global::System.Linq.IQueryable<AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj> sourceQueryable)
        {
            ...
            {
                case System.Type t when t == typeof(AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithMultipleCtor):
                    return global::System.Linq.Queryable.Cast<TDestination>(
                        global::System.Linq.Queryable.Select(sourceQueryable, source => new AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithMultipleCtor()
                        {
                            Id = source.Id,
                            Text = source.Text,
