...
namespace AutomapGenerator
{
    ...
    public class Mapper : IMapper
    {
        public TDestination Map<TDestination>(object source)
        {
            ...
            {
                case (AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj s, System.Type t) when t == typeof(AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithCompatibleCtor):
        ...
        public TDestination Map<TDestination>(object source, TDestination destination)
        {
            ...
            {
                case (AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj s, AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithCompatibleCtor d):
        ...
        private AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithCompatibleCtor MapInternal(AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj source, AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithCompatibleCtor destination)
        {
        ...
        private global::System.Linq.IQueryable<TDestination> ProjectInternal<TDestination>(global::System.Linq.IQueryable<AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.SourceObj> sourceQueryable)
        {
            ...
            {
                case System.Type t when t == typeof(AutomapGenerator.Generator.VerificationTests.ParameterizedCtor.Sources.DestWithCompatibleCtor):
