    ...
    public class Mapper : IMapper
    {
        public TDestination Map<TDestination>(object source)
        {
            switch (source, typeof(TDestination))
            {
                ...
                case (AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.SimpleSourceObj s, System.Type t) when t == typeof(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.OtherSimpleDestinationObj):
                    return (dynamic)MapInternal(s, new AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.OtherSimpleDestinationObj());
                default:
        ...
        private AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.OtherSimpleDestinationObj MapInternal(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.SimpleSourceObj source, AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.OtherSimpleDestinationObj destination)
        {
            destination.Id = source.Id;
            destination.Type = source.Type;
        ...
        private global::System.Linq.IQueryable<TDestination> ProjectInternal<TDestination>(global::System.Linq.IQueryable<AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.SimpleSourceObj> sourceQueryable)
        {
            switch (typeof(TDestination))
            {
                ...
                case System.Type t when t == typeof(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.OtherSimpleDestinationObj):
                    return global::System.Linq.Queryable.Cast<TDestination>(
                        global::System.Linq.Queryable.Select(sourceQueryable, source => new AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.OtherSimpleDestinationObj()
                        {
                            Id = source.Id,
                            Type = source.Type
                        }));
