...
namespace AutomapGenerator
{
    ...
    public class Mapper : IMapper
    {
        public TDestination Map<TDestination>(object source)
        {
            ...
            {
                case (AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullSourceObj s, System.Type t) when t == typeof(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullDestinationObj):
        ...
        private AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullDestinationObj MapInternal(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullSourceObj source, AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullDestinationObj destination)
        {
