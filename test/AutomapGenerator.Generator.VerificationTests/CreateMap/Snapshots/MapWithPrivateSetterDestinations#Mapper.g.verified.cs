...
namespace AutomapGenerator
{
    ...
    public class Mapper : IMapper
    {
        public TDestination Map<TDestination>(object source)
        {
            ...
            {
                case (AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullSourceObj s, System.Type t) when t == typeof(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.DestinationWithPrivateSetterProp):
                    return (dynamic)MapInternal(s, new AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.DestinationWithPrivateSetterProp());
                default:
        ...
        private AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.DestinationWithPrivateSetterProp MapInternal(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullSourceObj source, AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.DestinationWithPrivateSetterProp destination)
        {
        ...
        private global::System.Linq.IQueryable<TDestination> ProjectInternal<TDestination>(global::System.Linq.IQueryable<AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.FullSourceObj> sourceQueryable)
        {
            ...
            {
                case System.Type t when t == typeof(AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.DestinationWithPrivateSetterProp):
                    return global::System.Linq.Queryable.Cast<TDestination>(
                        global::System.Linq.Queryable.Select(sourceQueryable, source => new AutomapGenerator.Generator.VerificationTests.CreateMap.Sources.DestinationWithPrivateSetterProp()
                        {
                            Id = source.Id,
